...
namespace Datadog.Trace.DuckTyping
{
    ...
    public class DuckTypeException : Exception
    {
        ...
        public DuckTypeException(string message, Exception innerException)
    ...
    public class DuckTypeInvalidTypeConversionException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(Type actualType, Type expectedType)
        {
    ...
    public class DuckTypePropertyCantBeReadException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(PropertyInfo property)
        {
    ...
    public class DuckTypeFieldIsReadonlyException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(FieldInfo field)
        {
    ...
    public class DuckTypePropertyOrFieldNotFoundException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(string name, string duckAttributeName)
        {
    ...
    public class DuckTypeTargetMethodNotFoundException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo method)
        {
    ...
    public class DuckTypeProxyMethodParameterIsMissingException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo proxyMethod, ParameterInfo targetParameterInfo)
        {
    ...
    public class DuckTypeProxyAndTargetMethodParameterSignatureMismatchException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo proxyMethod, MethodInfo targetMethod)
        {
    ...
    public class DuckTypeProxyMethodsWithGenericParametersNotSupportedInNonPublicInstancesException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo proxyMethod)
        {
    ...
    public class DuckTypeTargetMethodAmbiguousMatchException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo proxyMethod, MethodInfo targetMethod, MethodInfo targetMethod2)
        {
    ...
    public class DuckTypeReverseProxyMissingMethodImplementationException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(IEnumerable<MethodInfo> methods)
        {
    ...
    public class DuckTypeReverseProxyMustImplementGenericMethodAsGenericException : DuckTypeException
    {
        ...
        [DebuggerHidden]
        [DoesNotReturn]
        public static void Throw(MethodInfo implementationMethod, MethodInfo targetMethod)
        {
